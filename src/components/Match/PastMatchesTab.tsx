import {
  Accordion, AccordionButton, AccordionItem, AccordionPanel, Box, Button, Card, CardBody, CardFooter, CardHeader, Heading, TabPanel, Text,
...
function PastMatchesTab({ matches } : { matches: Match[] }) {
                    ...
                    <AccordionItem>
                      ...
                      <AccordionPanel pb={4}>
                        <Text>
                          Minutes jouées:
                          {" "}
                          <Text as="b">{match.minutes_played}</Text>
                          <br />
                        </Text>
                        ...
                        <Text>
                          Carton(s) jaune(s):
                          {" "}
                          <Text as="b">{match.yellow_card}</Text>
                          <br />
                        </Text>
                        <Text>
                          Carton rouge:
                          {" "}
                          <Text as="b">{match.red_card}</Text>
                          <br />
                        </Text>
                        {position === "Gardien" ? (
                          <>
                            <Text>
                              But(s) encaissé(s):
                              {" "}
                              <Text as="b">{match.goals_conceded}</Text>
                              <br />
                            </Text>
                            <Text>
                              Arrêt(s):
                              {" "}
                              <Text as="b">{match.stops}</Text>
                              <br />
                            </Text>
                          </>
                        )
                          : (
                            <>
                              <Text>
                                But(s) inscrits(s):
                                {" "}
                                <Text as="b">{match.goals_scored}</Text>
                                <br />
                              </Text>
                              <Text>
                                Passe(s) décisive(s):
                                {" "}
                                <Text as="b">{match.assists}</Text>
                                <br />
                              </Text>
                            </>
                          )}
