    ...
    <>
      <div className="notices_container">
        ...
        <p>
          ...
          présent site internet www.anthedesign.fr sont :
        </p>

        <h3>Éditeur du site</h3>
        <p>
          SARL ANTHEDESIGN Numéro de SIRET : 752 217 356 00027 Responsable
          éditorial : Hugo ESSIQUE 12 Rue du huit Mai 1945, 60350 ATTICHY
          Téléphone : 09 72 21 25 07 Email : contact@anthedesign.fr Site web :
          www.anthedesign.fr Hébergement Hébergeur : SARL AntheDesign 12 Rue du
          Huit Mai 1945, 60350 ATTICHY – site web : www.anthedesign.fr
        </p>

        <h3>Développement</h3>
        <p>
          SARL AntheDesign 12 Rue du Huit Mai 1945, 60350 ATTICHY – site web :
          www.anthedesign.fr
        </p>
        ...
        <p>
          L’agence AntheDesign met en œuvre tous les moyens dont elle dispose,
          pour assurer une information fiable et une mise à jour fiable de ses
          sites internet. Toutefois, des erreurs ou omissions peuvent survenir.
        </p>

        <p>
          L’internaute devra donc s’assurer de l’exactitude des informations
          auprès de l’agence AntheDesign et signaler toutes modifications du
          site qu’il jugerait utile. AntheDesign n’est en aucun cas responsable
        ...
        <p>
          ...
          internet ou d’autres ressources disponibles sur Internet. L’agence
          AntheDesign ne dispose d’aucun moyen pour contrôler les sites en
          connexion avec ses sites internet.
        </p>

        <p>
          L’agence AntheDesign ne répond pas de la disponibilité de tels sites
          et sources externes, ni ne la garantit. Elle ne peut être tenue pour
          ...
          informations, produits ou services qu’ils proposent, ou de tout usage
          qui peut être fait de ces éléments.
        </p>
        ...
        <p>
          ...
          peuvent pas mettre en place un hyperlien en direction de
          www.anthedesign.fr sans l’autorisation expresse et préalable de
          l’agence AntheDesign.
        </p>

        <p>
          Dans l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en
          place un hyperlien en direction d’un des sites internet de SARL
          ANTHEDESIGN, il lui appartiendra d’adresser un email accessible sur le
          site afin de formuler sa demande de mise en place d’un hyperlien.
        </p>

        <p>
          La SARL ANTHEDESIGN se réserve le droit d’accepter ou de refuser un
        ...
        <p>
          ...
          présentés sur notre site www.anthedesign.fr.
        </p>

        <p>
          SARL ANTHEDESIGN s’efforce de fournir sur le site www.anthedesign.fr
          des informations aussi précises que possible. Les renseignements
          figurant sur le site www.anthedesign.fr ne sont pas exhaustifs et les
          photos non contractuelles.
        </p>

        <p>
          Ils sont donnés sous réserve de modifications ayant été apportées
          depuis leur mise en ligne. Par ailleurs, tous les informations
          indiquées sur le site www.anthedesign.fr sont données à titre
          indicatif, et sont susceptibles de changer ou d’évoluer sans préavis.
        </p>

        <p>
          Limitation contractuelles sur les données Les informations contenues
          sur ce site sont aussi précises que possible et le site est mis à jour
          à différentes périodes de l’année, mais peut toutefois contenir des
        ...
        <p>
          ...
          l’adresse contact@anthedesign.fr, en décrivant le problème de la
        ...
        <p>
          ...
          Internet ne sauraient engager la responsabilité de SARL ANTHEDESIGN.
        </p>

        <h3>Propriété intellectuelle</h3>
        <p>
          Tout le contenu du présent site www.anthedesign.fr, incluant, de façon
        ...
        <p>
          ...
          SARL ANTHEDESIGN. Cette représentation ou reproduction, par quelque
        ...
        <p>
          ...
          relative à l’informatique, aux fichiers et aux libertés, ce site a
          fait l’objet d’une déclaration 1656629 auprès de la Commission
          nationale de l’informatique et des libertés (www.cnil.fr).
        </p>

        <h3>Litiges</h3>
        <p>
          Les présentes conditions du site www.anthedesign.fr sont régies par
        ...
        <p>
          ...
          être amenés à nous communiquer des données telles que : votre nom,
          votre fonction, le nom de votre société, votre adresse électronique,
          et votre numéro de téléphone. Tel est le cas lorsque vous remplissez
          le formulaire qui vous est proposé en ligne, dans la rubrique «
          contact ».
        </p>
        ...
        <p>
          ...
          site internet, notamment des informations concernant l’utilisation de
          notre site, comme les zones que vous visitez et les services auxquels
          vous accédez, votre adresse IP, le type de votre navigateur, vos temps
          d’accès.
        </p>
