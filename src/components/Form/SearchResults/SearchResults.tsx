import {
  Text, Box, Card, CardHeader, Flex, Avatar, Heading, CardBody, CardFooter, ButtonGroup, Button,
} from "@chakra-ui/react";
import { isMobile } from "react-device-detect";
import { Player } from "@/@Types";

function SearchResults({ players } : { players:Player[] }) {
  return (
    <>
                ...
                <CardBody>
                  <div className="card_body_text">
                    <Text>
                      Poste:
                      {" "}
                      <Text as="b">{player.position}</Text>
                      <br />
                    </Text>
                    <Text>
                      Pied fort:
